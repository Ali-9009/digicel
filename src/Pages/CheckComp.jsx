    ...
    return (
        <main className="max-w-xl mx-auto h-dvh w-full overflow-y-auto bg-white flex flex-col items-center relative custom-scrollbar">
            ...
            <section className="flex-1 flex flex-col items-center text-center px-6 z-10 w-full pt-6">
                ...
                {/* IMEI Input Section */}
                <div className="mt-6 mb-6 w-full max-w-75 rounded-2xl bg-[#fff0f7] border border-(--primary-color)/20 p-6 shadow-sm">
                    ...
                    <button
                        ...
                        className="w-full h-11 rounded-full bg-(--primary-color) text-white text-xs font-semibold transition-colors"
                    >
                        CHECK COMPATIBILITY
                    </button>
                </div>
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-4">
                    <div className="w-full max-w-md rounded-3xl bg-white p-6 shadow-2xl">
                        ...
                        <button
                            ...
                            className="mt-8 w-full rounded-full bg-(--primary-color) px-4 py-3 text-sm font-semibold text-white"
                        >
                            CLOSE
                        </button>
                    </div>
